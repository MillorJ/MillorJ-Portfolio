...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full h-20 z-10 fixed text-black duration-300 ease-in ${
        pageScroll ? "bg-gradient-to-r from-black via-gray-800 to-gray-600 text-white" : "bg-gradient-to-r from-black via-gray-800 to-gray-600 text-white"
      }`}
    >
      ...
      >
        <div
          className={
            navigation
              ? "fixed left-0 top-0 w-4/5 h-full bg-gradient-to-r from-black via-gray-800 to-gray-600 text-white p-10 ease-in duration-500"
          ...
          <div className="flex w-full items-center justify-between">
            <Link href="/#home">
              <h2
                ...
                className="text-3xl font-bold uppercase tracking-wider cursor-pointer text-gradient"
              >
                MillorJ
              </h2>
            </Link>
            ...
            <ul className="uppercase">
              {links.map(({ id, link }) => (
                <Link key={id} href={`/#${link}`}>
                  <li
                    onClick={() => setNavigation(false)}
                    className="py-4 text-2xl tracking-wider cursor-pointer text-glow"
                  >
                    {link}
                  </li>
                </Link>
